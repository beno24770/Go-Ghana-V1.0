...
export function PackingListWidget({ className = "" }: PackingListWidgetProps) {
    ...
    return (
        <Card className={`p-6 flex flex-col bg-[#1F2937] text-white ${className}`}>
            <div className="flex justify-between items-start mb-6">
                <div className="w-full mr-4">
                    <div className="flex justify-between items-center mb-1">
                        ...
                        <p className="text-xs text-gray-400">{completedCount}/{items.length}</p>
                    </div>
                    {/* Progress Bar */}
            ...
            {/* Add Item Button */}
            <button className="flex items-center gap-2 text-sm text-gray-400 hover:text-white transition-colors mt-auto pt-4 border-t border-gray-700">
