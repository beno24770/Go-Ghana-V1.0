...
const travelStyles = [
    { id: 'backpacker', label: 'Backpacker', cost: '$30ΓÇô50/day', desc: 'Hostels, street food, public transport' },
    { id: 'budget', label: 'Budget', cost: '$50ΓÇô80/day', desc: 'Guesthouses, local eateries' },
    { id: 'mid-range', label: 'Mid-Range', cost: '$80ΓÇô150/day', desc: '3-star hotels, private transport' },
    { id: 'comfort', label: 'Comfort', cost: '$150ΓÇô250/day', desc: '4-star hotels, driver' },
...
export function BudgetForm({ onSubmit, isLoading = false }: BudgetFormProps) {
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            <div className="space-y-4">
                <label className={cn(
                    ...
                    />
                    <div>
                        <span className="font-bold block">IΓÇÖm new to Ghana ΓÇö recommend for me</span>
                    ...
                    <div className="flex items-center justify-between py-3 border-b border-gray-200 group">
                        <div className="flex items-center gap-3 flex-1">
                            ...
                            <div>
                                ...
                                <span className="text-lg font-bold text-ghana-green">{watchedValues.duration} days ΓÇó {watchedValues.travelers} {watchedValues.travelers === 1 ? 'traveler' : 'travelers'}</span>
                            </div>
                        </div>
                        <Button
                            type="button"
    ...
    const stepTitles = [
        ...
        },
        {
            ...
            subtitle: "Choose your comfort levelΓÇöfrom backpacker to luxury. This helps us match you with the right accommodations.",
            icon: Briefcase
        },
        {
        ...
        },
        {
            ...
            subtitle: "Choose your preferred mode of transportΓÇöthis affects your daily costs.",
            icon: Calculator
        },
        {
                ...
                <CardFooter className="flex flex-col-reverse sm:flex-row justify-between p-6 bg-secondary/5 border-t gap-3 sm:gap-0">
                    ...
                    {step < totalSteps ? (
                        ...
                        <Button type="submit" className="gap-2 px-8 bg-ghana-green hover:bg-green-800 w-full sm:w-auto text-white shadow-lg hover:shadow-ghana-green/20" disabled={isLoading}>
                            {isLoading ? 'Calculating...' : 'Generate My Budget ΓåÆ'} <Check className="h-4 w-4" />
                        </Button>
                    )}
                </CardFooter>
            </form>
